...
class ModelEvalution:
    ...
    def intializig_model_evalution(self) -> ModelEvaluationArtifact:
        try:
            # Loading the train and test file path from data_validation
            ...
            # For lenthy work --> Concating train and test as df
